    ...
    <FadeIn>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex gap-3">
          <Link href="/admin/productos/nuevo" className="inline-flex items-center justify-center rounded-xl bg-cyan px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-cyan/90">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-10">
        {adminModules.map((mod, i) => (
          <Link
            key={i}
            href={mod.href}
            className="group flex flex-col justify-between rounded-2xl border border-border/50 bg-card p-6 shadow-sm transition-all hover:border-cyan/30 hover:shadow-md"
          >
            <div>
